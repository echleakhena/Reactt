        ...
        <div className="container-fluid bg-breadcrumb">
          <div className="container text-center py-5" style={{ maxWidth: 900 }}>
            ...
            >
              ...
              <li className="breadcrumb-item active text-secondary">សាលសហសិក្សា</li>
            </ol>
          </div>
        </div>
        &lt;
          ...
          <div className="container py-5">
            ...
            >
              <div className="sub-style">
                <h5 className="sub-title text-primary px-3">Our Food</h5>
              </div>
              <h1 className="display-5 mb-4">BELTEI INTERNATIONAL UNIVERSITY</h1>
              <p className="mb-0">Dilisuss food</p>
            </div>
                ...
                <div className="service-item">
                  <div className="service-inner">
                    ...
                    <div className="service-title">
                      ...
                      <div className="service-content pb-4">
                        <a href="#">
                          <h4 className="text-white mb-4 py-3">Food</h4>
                        </a>
                        <div className="px-4">
                          <p className="mb-4">
                            Good envirronment
