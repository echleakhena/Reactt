        ...
        <div className="container-fluid bg-breadcrumb">
          <div className="container text-center py-5" style={{ maxWidth: 900 }}>
            ...
            >
              ...
              <li className="breadcrumb-item active text-secondary">Class</li>
            </ol>
          </div>
        </div>
          ...
          <div className="container py-5">
            ...
            >
              <div className="sub-style">
                <h5 className="sub-title text-primary px-3">Our Class</h5>
              </div>
              <h1 className="display-5 mb-4">
                {" "}
                Class in BELTEI INTERNATIONAL UNIVERSITY
              </h1>
              <p className="mb-0" />
            </div>
