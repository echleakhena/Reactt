              ...
              <div className="navbar-nav ms-auto py-0">
                ...
                <div className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu m-0">
                    ...
                    <a href="Countries" className="dropdown-item active">
                      សាលសហសិក្សា
                    </a>
        ...
        <div className="container-fluid bg-breadcrumb">
          <div className="container text-center py-5" style={{ maxWidth: 900 }}>
            ...
            >
              ...
              <li className="breadcrumb-item active text-secondary">Event</li>
            </ol>
          </div>
        </div>
        {/* Training Start */}
          ...
          <div className="container py-5">
            ...
            >
              <div className="sub-style">
                <h5 className="sub-title text-primary px-3">Event</h5>
              </div>
                ...
                <div className="training-item">
                  ...
                  <div className="training-content bg-secondary rounded-bottom p-4">
                    ...
                    <a
                      ...
                      href="contact.html"
                    >
                      buy now <i className="fa fa-arrow-right" />
                    </a>
                  </div>
                </div>
              </div>
